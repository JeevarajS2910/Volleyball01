...
def train():
    ...
    # Dynamically resolve paths to support both local Windows
    script_dir = os.path.dirname(os.path.abspath(__file__))
    base_dir = os.path.join(script_dir, "volleyball.yolov11")
    weights = os.path.join(script_dir, "yolo11n.pt")
    project_dir = os.path.join(script_dir, "YOLOv11", "runs")
    ...
    print("\n" + "=" * 60)
    print("STEP 3: Starting YOLOv11 training")
    print("=" * 60)
